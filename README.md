[![pre-commit.ci status](https://results.pre-commit.ci/badge/github/pre-commit/pygrep-hooks/master.svg)](https://results.pre-commit.ci/latest/github/pre-commit/pygrep-hooks/master)
